...
# 1. Load your dataset
file_path = "/explore/nobackup/people/spotter5/anna_v/v2/v2_model_training_data_with_lags_filled.csv"
...
predictor_vars = [
    ...
    'silt_0_100cm', 'soc_0_100cm', 'co2_cont', 'land_cover',
    ...
    "tmean_C_lag1", "tmean_C_lag2", "tmean_C_lag3", 'month'
]
target_var = 'gpp'
...
# 3. Define predictors and target
# Updated feature list to include lagged variables
feature_cols = [
    # Original base predictors
    'EVI', 'NDVI', 'sur_refl_b01', 'sur_refl_b02',
    'sur_refl_b03', 'sur_refl_b07', 'NDWI', 'pdsi', 'srad',
...
figures_path = os.path.join(out_path, "figures_lag")
...
# Save to disk with '_cat_lag' suffix
results_csv_path = os.path.join(out_path, f'catboost_results_{target_col}_cat_lag.csv')
predictions_csv_path = os.path.join(out_path, f'catboost_predictions_{target_col}_cat_lag.csv')
...
if not unique_sites.any():
    ...
    for site in unique_sites:
        ...
        # Define the output path for the plot with '_cat_lag' suffix
        plot_filename = f'catboost_{target_col}_{site}_timeseries_cat_lag.png'
