...
#-----land cover will use abcflux for this
...
def run_loso_analysis(target_col):
    ...
    loocv_out_path = os.path.join("/explore/nobackup/people/spotter5/anna_v/v2/loocv_abc", target_col)
    figures_path = os.path.join(loocv_out_path, "figures")
    models_out_path = '/explore/nobackup/people/spotter5/anna_v/v2/models_abc'
    ...
    # --- START: EDITED SECTION (summary stats across sites) ---
    ...
    # 8. Plotting: per-site time series (existing)
