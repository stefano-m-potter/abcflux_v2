...
def run_loso_analysis(target_col):
    ...
    file_path = "/explore/nobackup/people/spotter5/anna_v/v2/v2_model_training_v4_lagged.csv"
    ...
    feature_cols =  [
        ...
        'wcres_WCres_0_100cm', 'wcsat_WCsat_0_100cm',  'temp_ctx', 'pr_ctx','ndvi_ctx', 'snow_cover_ctx', 'snow_depth_ctx'
    ]
